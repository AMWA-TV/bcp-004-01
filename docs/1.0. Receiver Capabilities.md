...
IS-04 requires that the core [resource `version`](https://specs.amwa.tv/is-04/tags/v1.3/docs/2.1._APIs_-_Common_Keys.html#version) is updated when any attributes of the `caps` object or resource as a whole are changed.
